            ...
            ibootstrap: {
                ...
                preset: function(preset, objParam) {
                    ...
                    if(typeof preset!="string") {
                        console.error("Rapid.ibootstrap.preset: Must pass a string for the first parameter that is \"container\", \"well\", \"row\", \"col\", \"colxs\", \"colsm\", \"colmd\", \"collg\", or any column class from \"col-xs-1\" to \"col-lg-12\".");
                        return "";
                    }
                    ...
                    if(arguments.length>1 && typeof arguments[1] == "object") {
                      for(var key in objParam) {
                        ...
                        console.error("Rapid.ibootstrap.preset: 2nd parameter must be an object that further specifies the Bootstrap div being created. Eg. {class:\"bg-primary text-center\", style:\"color:gray; font-weight: 600\", attr:\"data-here data-also\", inner:\"Created.\"}");
                        return;
